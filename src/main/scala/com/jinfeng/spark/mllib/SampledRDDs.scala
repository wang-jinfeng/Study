...
object SampledRDDs {
  ...
  case class Params(input: String = "file:/D:/Program Files/JetBrains/IntelliJ IDEA/Workspaces/Spark/src/main/resources/input/sample_binary_classification_data.txt")
